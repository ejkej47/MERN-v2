...
export default function ModuleCard({
  ...
  // Supabase vraća lekcije kao niz ako radiš join, inače je prazan niz
  ...
  return (
    ...
    >
      ...
      <div className="p-5 flex flex-col flex-1">
        ...
        {/* Lessons preview - prikazuje lekcije ako su povučene iz baze */}
        {preview.length > 0 && (
        ...
        <div className="mt-auto pt-4 flex flex-col gap-2">
          ...
          <button
            ...
            className="rounded-lg bg-accent px-4 py-2 text-black font-semibold hover:bg-accent-hover transition text-sm shadow-sm"
          >
