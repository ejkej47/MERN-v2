...
export default function Footer() {
  return (
    <footer className="relative mt-24 bg-[var(--bg-accent-green)] text-[var(--text-main)]">
      ...
      {/* Zatalasani prelaz (Slojeviti talasi BEZ sabiranja boja) */}
      <div className="absolute bottom-full left-0 w-full overflow-hidden leading-none">
        ...
        >
          <defs>
            {/* Maska 1: Iseca površinu NAJKRAĆEG (prednjeg) talasa */}
            <mask id="mask-front">
              <rect width="1440" height="320" fill="white" />
              <path d="M0,224L48,213.3C96,203,192,181,288,181C384,181,480,203,576,213.3C672,224,768,224,864,202.7C960,181,1056,139,1152,133.3C1248,128,1344,160,1392,176L1440,192L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z" fill="black" />
            </mask>
            
            {/* Maska 2: Iseca površinu SREDNJEG talasa */}
            <mask id="mask-middle">
              <rect width="1440" height="320" fill="white" />
              <path d="M0,160L48,170.7C96,181,192,203,288,208C384,213,480,203,576,176C672,149,768,107,864,101.3C960,96,1056,128,1152,149.3C1248,171,1344,181,1392,186.7L1440,192L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z" fill="black" />
            </mask>
          </defs>

          {/* 1. ZADNJI TALAS (Najviši, dopire do M0,96). Primenjujemo mu masku srednjeg talasa. */}
          <path 
            fill="var(--bg-accent-green)" 
            fillOpacity="0.3" 
            mask="url(#mask-middle)"
            d="M0,96L48,112C96,128,192,160,288,160C384,160,480,128,576,122.7C672,117,768,139,864,149.3C960,160,1056,160,1152,138.7C1248,117,1344,75,1392,53.3L1440,32L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"
          ></path>
          
          {/* 2. SREDNJI TALAS (Dopire do M0,160). Primenjujemo mu masku prednjeg talasa. */}
          <path 
            fill="var(--bg-accent-green)" 
            fillOpacity="0.6" 
            mask="url(#mask-front)"
          ...
          {/* 3. PREDNJI TALAS (Najkraći, dopire do M0,224). On je na samom dnu dizajna, pa mu ne treba maska. */}
          <path 
            fill="var(--bg-accent-green)" 
            fillOpacity="1" 
